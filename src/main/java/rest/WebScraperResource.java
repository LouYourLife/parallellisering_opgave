...
public class WebScraperResource {
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public String getTagsParrallel() throws ExecutionException, NotImplementedException, InterruptedException {
        long startTime = System.nanoTime();
        List<TagDTO> dataFetched = Tester.runParrallel();
        long endTime = System.nanoTime() - startTime;
        //return "[Make me return results, fetched by a parrallel strategy";
        return TagDTO.getTagDTOsAsJson("Parallel fetching", dataFetched, endTime);
    }
