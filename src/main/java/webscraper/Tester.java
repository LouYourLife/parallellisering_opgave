...
public class Tester {
    ...
    public static List<TagDTO> runParrallel() throws NotImplementedException, InterruptedException, java.util.concurrent.ExecutionException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<TagDTO> fetchedData2 = new Tester().runParrallel();
        ...
        for (TagDTO tagDTO : fetchedData2) {
            System.out.println("Div's: "+tagDTO.divCount);
            System.out.println("Body's: "+tagDTO.bodyCount);
            System.out.println("----------------------------------");
        }
